                                ...
                                <form onSubmit={this.uploadImage}>
                                    <div className="row justify-content-center my-5">
                                        <div className="col-12 ">
                                            ...
                                            <input onChange={(e) => { this.setState({ visible: true, image: e.target.files[0] ,tempImage: e.target.files[0] ? URL.createObjectURL(e.target.files[0]) : defaultImg }) }} className="d-none" type="file" name="" id="upload-pic" />
                                        </div>
