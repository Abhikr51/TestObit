    ...
    render() {
        ...
        return (
            <motion.div
                ...
                className="wrapper">
                <div style={{ height: 'fit-content', borderBottomRightRadius: '50px', borderBottomLeftRadius: '0%' }} className="topbar">
                    <div style={{ width: "165px" }} className="splash-logo">
                        ...
                        <form className="login-validation" noValidate onSubmit={this.loginSubmit}>
                            <div className="row justify-content-center">
                                <div className="col-11 my-1">
                                    ...
                                    <div className="input-group flex-nowrap mt-1 mb-3">
